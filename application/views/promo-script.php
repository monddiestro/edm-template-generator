<script>
    ...
    $('#btn_generate').on('click',function(){
        ...
        var base_url = "<?php echo base_url('welcome/promo_template') ?>"
        var url = base_url+'?header_title='+header_title+'&header_img='+header_img+'&img_one='+img_one+'&title_one='+title_one+'&desc_one='+desc_one+'&url_one='+url_one+'&img_two='+img_two+'&title_two='+title_two+'&desc_two='+desc_two+'&url_two='+url_two+'&img_three='+img_three+'&title_three='+title_three+'&desc_three='+desc_three+'&url_three='+url_three;
        window.location = url;
    });
