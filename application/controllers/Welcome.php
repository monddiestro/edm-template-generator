...
class Welcome extends CI_Controller {
	...
	public function used_promo_template() {
		...
		if(empty($header_img)) {
			...
			$data["template"] = $this->used_promo_boilerplate($header_title,$header_img,$header_url,$img_one, $title_one,$desc_one,$url_one,$img_two,$title_two,$desc_two,$url_two,$img_three,$title_three,$desc_three,$url_three);
		}

		$this->load->view('head.php');
		$this->load->view('used-promo.php',$data);
		$this->load->view('plugins.php');
		$this->load->view('used-promo-script.php');
		$this->load->view('footer.php');

	}

	function used_promo_boilerplate($header_title,$header_img,$header_url,$img_one, $title_one,$desc_one,$url_one,$img_two,$title_two,$desc_two,$url_two,$img_three,$title_three,$desc_three,$url_three) {
		...
		$template .= '<table border="0" cellpadding="20" cellspacing="0" width="100%" >    ';                           
		$template .= '<tr>';
		$template .= '<td align="center" valign="top" style="padding-top:0;padding-right:0px;padding-left:0px;">';
		$template .= '<!-- header image -->';
		$template .= '<img style="width:100%;" src="'.$header_img.'" alt="Banner">';
		$template .= '</td>     ';                               
		$template .= '</tr>';
		$template .= '</table>';
		$template .= '</td>';
