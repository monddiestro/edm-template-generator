...
class Welcome extends CI_Controller {
	...
	function news_boilerplate($header_title,$header_img,$header_desc,$header_url,$news_one_img,$news_one_title,$news_one_desc,$news_one_url,$news_two_img,$news_two_title,$news_two_desc,$news_two_url,$news_three_title,$news_three_desc,$news_three_url,$features_one_img,$features_one_title,$features_one_desc,$features_one_url,$features_two_title,$features_two_desc,$features_two_url,$tips_one_img,$tips_one_title,$tips_one_desc,$tips_one_url,$tips_two_title,$tips_two_desc,$tips_two_url) {
		...
		$template .= '</tr>';
		$template .= '<tr>';
		$template .= '<td valign="top" style="font-family:  Roboto,-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Helvetica Neue,Arial,sans-serif,Apple Color Emoji,Segoe UI Emoji,Segoe UI Symbol!important;font-style: normal;font-weight: bold;font-size: 24px;color: #363D41;padding-bottom:16px;">';
		$template .= '<!-- News title -->';
		$template .= $news_one_title;
		$template .= '</td>';
		$template .= '</tr>';
		$template .= '<tr>';
		$template .= '<td valign="top" style="font-family:  Roboto,-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Helvetica Neue,Arial,sans-serif,Apple Color Emoji,Segoe UI Emoji,Segoe UI Symbol!important;font-style: normal;font-weight: normal;line-height: 32px;font-size: 20px;color: #363D41;padding:0 32px;">';
		...
		$template .= '</tr>';
		$template .= '<tr>';
		$template .= '<td valign="top" style="font-family:  Roboto,-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Helvetica Neue,Arial,sans-serif,Apple Color Emoji,Segoe UI Emoji,Segoe UI Symbol!important;font-style: normal;font-weight: normal;line-height: 32px;font-size: 18px;color: #363D41;padding:0 32px;">';
		...
		$template .= '<a href="'.$news_three_url.'" style="color:#006FC1;text-decoration:underline;">Read more ></a> ';
		$template .= '</span>';
		$template .= '</td>';
		$template .= '</tr>';
		$template .= '<tr>';
		...
		$template .= '<!-- please insert link/url on (href="") tag -->';
		$template .= '<a  href="'.$features_two_url.'" style="color:#006FC1;text-decoration:underline;">Read more ></a> ';
		$template .= '</span>';
		$template .= '</td>';
		$template .= '</tr>';
		$template .= '<tr>';
		...
		$template .= '<!-- please insert link/url on (href="") tag -->';
		$template .= '<a href="'.$tips_two_url.'" style="color:#006FC1;text-decoration:underline;">Read more ></a> ';
		$template .= '</span>';
		$template .= '</td>';
		$template .= '</tr>';
		$template .= '</table>';
